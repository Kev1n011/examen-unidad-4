      ...
      <ul class="pc-navbar">
        ...
        <li class="pc-item pc-hasmenu">
          ...
          <ul class="pc-submenu">
            ...
            <li class="pc-item"><a class="pc-link" href="../application/ecom_product-details.html">Product details</a>
            </li>
        ...
        <li class="pc-item pc-hasmenu">
          ...
          <ul class="pc-submenu">
            ...
            <li class="pc-item"><a class="pc-link" href="<?= BASE_PATH ?>users/user_list">User List</a></li>
          ...
          <div class="flex-grow-1 ms-3">
            <div class="dropdown">
              ...
              <div class="dropdown-menu">
                <ul>
                  <li>
                    <a href="<?= BASE_PATH ?>/my_account/<?php echo str_replace(' ', '-', $user_sidebar['name']); ?>"
                      class="pc-user-links">
