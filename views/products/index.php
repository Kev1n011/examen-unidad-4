                  ...
                  <?php 
                    ...
                    <div class="card product-card">
                      <div class="card-img-top">
                         ...
                         <form method="GET">
                         <a href="./details/'.$producto['slug'].'">
                          <img src= "' . $producto['cover'] . '" alt="image" class="img-prod img-fluid" style="width: 400px; height: 400px; object-fit: cover;"  />
                        </a>
												</form>
                      ...
                      <div class="card-body">
                        ...
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1 ms-3">
                            ...
                            <div class="col-4">
												<form method="POST" id="eliminar_producto_' . $producto['id'] . '">
