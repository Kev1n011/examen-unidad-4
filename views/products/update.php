          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="nombre" class="form-control" placeholder="Enter Product Name"
              ...
              <div class="mb-3">
                ...
                <select class="form-select" name="brand_dropdown" id="brand_dropdown"
                  aria-label="Default select example">
                  <?php
                  foreach ($brands as $brand) {
                    if ($producto['brand_id']) {
                      echo '<option value="' . $producto['brand']['id'] . '">' . $producto['brand']['name'] . '</option>';
                      foreach ($brands as $brand) {
                        if ($producto['brand']['id'] == $brand['id']) { //No repetir la marca dos veces
